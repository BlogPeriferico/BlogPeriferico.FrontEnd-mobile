...
export default function StackNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="EsqueciSenhaEmail" component={EsqueciSenhaEmail} options={{ headerShown: false }} />
      <Stack.Screen name="EsqueciSenhaCodigo" component={EsqueciSenhaCodigo} options={{ headerShown: false }} />
