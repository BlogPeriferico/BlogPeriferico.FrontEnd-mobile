...
slide: {
  width: Dimensions.get("window").width, // largura EXATA da tela
  justifyContent: "center",
  alignItems: "center",
  ...
  ctaText: { fontFamily: "Poppins-SemiBold", fontSize: 7.5 },
  ctaArrow: { fontFamily: "Poppins-Bold", fontSize: 9, marginTop: -1 },
